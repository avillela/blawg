...
slug: how-to-be-an-ethical-engineering-leader
description: "Doing the right thing isn’t always easy. Here are eight ways to help prioritize being an ethical engineering leader."
added: "Mar 21, 2023"
tags:
  - technical
  - thought-leadership
...
Space llamas designed by [Hillary Chen](https://www.linkedin.com/in/hillary-chen-a934a715a/).

[_This article_](https://leaddev.com/personal-development/how-be-ethical-engineering-leader) _was originally published on_ [_LeadDev.com_](https://leaddev.com/personal-development/how-be-ethical-engineering-leader) _on January 12th, 2023._
...
I once worked in a company where operations (ops) team members constantly monitored emails after-hours to check if production systems were down. [Not because they were on-call](https://leaddev.com/process/call-necessary-function-any-organization), but because they relied on the fact that certain systems went down regularly. They were making so much money in overtime from restarting servers for these flaky systems, that there was no incentive for them to work towards making the underlying systems more resilient.
...
[Liz Fong-Jones](https://leaddev.com/community/liz-fong-jones) of Honeycomb put it perfectly in [Episode 1 of the On-Call Me Maybe Podcast](https://oncallmemaybe.com/episodes/how-to-rock-at-sre-with-liz-fong-jones-of-honeycomb), when she urged engineers to write their own tests, their own comments, and their own instrumentation. As developers, we know our code best, and are therefore best suited for these tasks. Putting a little tender loving care into your code goes a long way.
...
Our industry could benefit from [building similarly safe spaces for engineers](https://leaddev.com/diversity-inclusion/creating-safe-space-your-team) to learn new skills without judgment, and by teaching and mentoring junior engineers with greater humility.
...
If you prefer videos over blog posts, you can check out my talk on the same topic at Open Source Summit 2023 below:

Open Source Summit 2023: How to Be an Ethical Engineering Leader

_Originally published at_ [_https://leaddev.com_](https://leaddev.com/personal-development/how-be-ethical-engineering-leader)_._

By [Adriana Villela](https://medium.com/@adri-v) on [March 21, 2023](https://medium.com/p/97f26adbd38).

[Canonical link](https://medium.com/@adri-v/how-to-be-an-ethical-engineering-leader-97f26adbd38)
