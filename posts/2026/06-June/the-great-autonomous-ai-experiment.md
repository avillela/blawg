...
![Paperclip dashboard. Image made with Claude.](/images/posts/the-great-autonomous-ai-experiment/paperclip-architecture.png "A dark dashboard showing agent counts, zero recent activity, and a sidebar listing work items, projects, and multiple agent roles.")
...
![A three‑layer diagram showing Paperclip at the top, BMAD skill roles in the middle, and Claude Sonnet as the model executing those skills at the bottom.](/images/posts/the-great-autonomous-ai-experiment/paperclip-architecture.png "User Paperclip, BMAD, and Claude. Image made with Claude.")
...
![An org chart with a CEO at the top, a Crew Manager beneath, and nine specialized engineering and agent roles branching below.](/images/posts/the-great-autonomous-ai-experiment/bmad-crew-org-chart.png "BMAD Crew org chart in Paperclip. Generated by Paperclip.")
...
![A stats dashboard showing May 2026 YouTube and podcast metrics with a line graph comparing views and downloads.](/images/posts/the-great-autonomous-ai-experiment/geeking-out-ui-overall-stats.png "The Geeking Out Dashboard created by Winston")
...
![A four‑step workflow diagram showing company goals flowing into projects, then requirements, then issue tracking.](/images/posts/the-great-autonomous-ai-experiment/paperclip-flow.png "My BMAD workflow managd by Paperclip.")
...
![A dark interface showing a technical post listing MVP implementation tasks, followed by a comment questioning why the CTO is doing development work.](/images/posts/the-great-autonomous-ai-experiment/bmad-wrong-assignee.png "Uh...what's going on here?")
...
![A dark task‑tracking interface showing a conversation where a task is reassigned from one user to an architect after board direction.](/images/posts/the-great-autonomous-ai-experiment/bmad-wrong-assignee-2.png "I'm this close to firing the Crew Manager...")
...
![A dark project dashboard showing a four‑phase workflow table where each phase is assigned to a different role and later phases are blocked until earlier ones are completed.](/images/posts/the-great-autonomous-ai-experiment/bmad-crew-handoff.png "Paperclip and BMAD are playing nice at last!")
...
![A stats dashboard comparing April YouTube metrics with podcast download numbers, plus a trend graph showing daily views and downloads.](/images/posts/the-great-autonomous-ai-experiment/geeking-out-ui-overall-stats-v2.png "The new Geeking Out Dashboard created by the Paperclip BMAD Crew")
...
![A light‑colored rat peeks out from a soft hammock, surrounded by patterned fabric in a cozy enclosure.](/images/posts/the-great-autonomous-ai-experiment/duckie-lounging.jpg "Duckie lounging on a lazy weekend afternoon.")
