---
title: "From “I Don’t Know” to “Let Me Show You How”"
slug: from-i-don-t-know-to-let-me-show-you-how
description: "Eight Lessons to Inspire You to Do Great Things"
added: "Nov 21, 2024"
tags:
  - technical
  - advice
...
I have been doing computer things for 24 years. Longer, if you count the fact that I learned how to code in [BASIC](https://en.wikipedia.org/wiki/BASIC) when I was 10. Which makes me officially old.

I am a 2nd-year [CNCF Ambassador](https://www.cncf.io/people/ambassadors/), 3rd-year [HashiCorp Ambassador](https://www.hashicorp.com/ambassador/directory), [blogger](https://adri-v.medium.com), and [podcaster](https://youtube.com/@geekingout_pod). I’ve had incredible guests on my podcast such as [Kelsey Hightower](https://youtu.be/9XtHIOq7_WI), [Charity Majors](https://youtu.be/qKQLZ9WsEQs), [Hazel Weakly](https://youtu.be/7ArXctrVCzM), and [Julia Morgado](https://youtu.be/Up--3nQfX-c). [I’ve given talks](https://youtube.com/playlist?list=PL2n5EpcOFZfuBRsG6CFY3swZfKbW9_HCL&si=cNXNdnJ_jblfOVBz) at [KubeCons](https://www.cncf.io/kubecon-cloudnativecon-events/) and [Open Source Summits](https://en.wikipedia.org/wiki/Open_Source_Summit) in North America and Europe. By day I am a Developer Advocate in the Observability space, spending most of my time working in [OpenTelemetry](https://opentelemetry.io) (OTel), specifically as a maintainer of the [OTel End User SIG](https://opentelemetry.io/community/end-user/). And by night, [I climb walls](https://instagram.com/adrianamvillela) ([and sometimes fall from them](https://youtube.com/shorts/N6-v5nE4FhU?si=gBwiRjz_-ZuT7eyi)…badly). I also love [capybaras](https://en.wikipedia.org/wiki/Capybara), because they’re cute, cuddly, and make me smile.
...
But the biggest takeaway I have from my consulting days is the phrase, “You are the expert”. The irony is that half the time, we weren’t the experts at all. But we were brought in as the experts, hired by companies to solve some sort of tech problem. Therefore, we _had_ to be the experts.
...
Some of the best changes can come from pain. That’s how I got into [DevOps](https://en.wikipedia.org/wiki/DevOps). Picture this. It was around 2014. I was managing a production deployment. In those days, at the company I worked at, we had to write our deployment instructions in a Word doc, and hand them over to someone offshore who was responsible for doing the deployment.

This meant that:

1.  I had to ensure that my instructions were correct
2.  The person doing the deployment had to ensure that they read the instructions correctly
3.  The person doing the deployment had to ensure that they _executed_ the instructions correctly
...
It took the whole weekend, but we managed to sort things out. This should’ve taken a few hours, by the way. Frustrated, I vented to my dad about it the next week. Oh, did I mention that my dad is in his eary 70s, and is a retired software architect who learned [Rust](https://en.wikipedia.org/wiki/Rust_%28programming_language%29) for fun in 2022 and has contributed his own [Crates](https://crates.io)?
...
When I was asked to join the DevRel team at [Lightstep](https://en.wikipedia.org/wiki/Lightstep) (now owned by ServiceNow), I felt like the biggest impostor. On my team were [Ted Young](https://www.linkedin.com/in/ted-young/), one of the founders of OpenTelemetry; [Austin Parker](https://www.linkedin.com/in/austinlparker), OpenTelemetry community manager; and Ana Margarita Medina, who is well known in the DevRel space for her mental health advocacy and her work in reliability and chaos engineering. Who the fuck was I? I didn’t belong there.

Let me rewind a bit. In my previous job, I managed two teams: a platform engineering team using all [HashiCorp](https://hashicorp.com) tools, including [Nomad](https://www.nomadproject.io), and an [Observability](https://www.oreilly.com/library/view/fundamentals-of-observability/0636920926597/) team. And guess what? I didn’t really know much about either.
...
The [Observability blog posts](https://adri-v.medium.com/list/unpacking-observability-be1835c6dd23) caught the attention of Austin Parker, who invited me to join his DevRel team at Lightstep.

My [HashiCorp learnings](https://adri-v.medium.com/list/hashicorp-09e9db4a78a3) caught the attention of fellow Hashi community member, [Riaan Nolan](https://www.linkedin.com/in/riaannolan), who nominated me for a HashiCorp Ambassadorship in 2021, which I still hold today.
...
For example, remember when I told you that I had to learn HashiCorp Nomad for a previous job? Well, last year I came up with a wild idea. Kelsey Hightower has his famous “[Hashinetes](https://github.com/kelseyhightower/nomad-on-kubernetes)” tutorial, in which he runs Nomad on [Kubernetes](https://kubernetes.io). So I thought to myself, “What happens if you try to run Kubernetes on Nomad? Can it be done?”

So I set out to do just that. Spoiler alert: [I got it to work](https://adri-v.medium.com/the-power-of-collaboration-running-k0s-on-nomad-37adad1f1f1f). Now, you might be wondering, why the hell did I decide to do that?? Was there any practical application? Not really. I was just curious to see if I could do it. But I learned so much about the inner workings of Kubernetes and Nomad along the way. And I also learned about the power of collaboration.

Because you see, I didn’t do this alone. I did this with the help of [Luiz Aoqui](https://youtu.be/TD_JOC8FUWs), who, at the time, was a developer on Nomad. It so happens that we met on Twitter a couple of years earlier, as a result of me promoting my various blog posts on cool Nomad experiments on social media. Again, another wonderful reason why self-promotion is great: it allows you to meet tons of people whom you might have never otherwise met.
...
We learn more from our mistakes than we do from being perfect. Every error we make teaches us something new. Take coding, for example. When I make a mistake in my code, and I’m trying to debug it, I learn more from the debugging session than I would have if my code had been perfect the first time around.
...
As I reflect on my ill-fated year as a photographer, I can say with confidence I totally failed at it. Like, fell flat on my face. I blew through my savings, I worked long hours, and I was miserable. But it was the best worst year of my life. Why? Because I learned something about myself. I learned that I didn’t want to be a professional photographer. I learned that I actually _wanted_ to be in tech, but that I was just horridly bored with my tech career.
...
![A small rat with light brown fur and a pink nose is peeking out from a dark-colored pocket. The pocket is part of a garment with a black and beige vertical striped pattern. The rat’s head is turned slightly upward, and its ears are visible. The image captures a cute and unexpected moment of a rat comfortably nestled in a pocket.](https://cdn-images-1.medium.com/max/800/1*eN_GPPF8EON5XQlziDsNUw.jpeg)

Katie Jr. loves cuddly places.

Until next time, peace, love, and code. ✌️💜👩‍💻

_This post is based on the keynote talk that I gave at_ [_KCD Porto 2024_](https://kcdporto.github.io/speakers.html)_._

By [Adriana Villela](https://medium.com/@adri-v) on [November 21, 2024](https://medium.com/p/4be0c79e57c8).

[Canonical link](https://medium.com/@adri-v/from-i-dont-know-to-let-me-show-you-how-4be0c79e57c8)
